...
module.exports = {
  ...
  **************************************************************************/
  datastores: {
    ...
    ***************************************************************************/
    default: {
      adapter: 'sails-mysql',
      url: 'mysql://myadmin@vrx2db1:GreenL1ttleCub3$@vrx2db1.mysql.database.azure.com:3306/medivrx_prod',
      //--------------------------------------------------------------------------
  ...
  ***************************************************************************/
  session: {
    ...
    ***************************************************************************/
    ...
    // url: 'redis://vrx2redis1:6DWSeLqB9qAu+VG4yssb9HOu2OSO8HUOakfKY2z+sqg=' +
    // '@vrx2redis1.redis.cache.windows.net:6380/databasenumber',
    //--------------------------------------------------------------------------
  ...
  **************************************************************************/
  // ssl: undefined,
  ssl: {
    ca: require('fs').readFileSync(require('path').resolve(__dirname, '../ssl/rootCA.crt')),
